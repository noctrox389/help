...
-- Additional new/modified parts for the D'lowing mod by: Xellend 
...
local offsetY = 188
local objWidth = 320
local creatorD = "Composer: Rareblin, Pogo"
local creatorB = "Composer: Cval, Pogo"
local creatorM = "Composer: Quik06, Pogo"
...
function onCreatePost()
	...
	if (songName == "D'lowing") then
	setTextString("botplayTxt", "haha queer man with kids")
	...
	setTextString("botplayTxt", "haha fatherless")
	elseif downScroll then
		setProperty("botplayTxt.y", getProperty("healthBar.y")+40)
	else
		setProperty("botplayTxt.y", getProperty("healthBar.y")-60)
	...
	setTextString("botplayTxt", "haha monster")
	elseif downScroll then
		setProperty("botplayTxt.y", getProperty("healthBar.y")+40)
	else
		setProperty("botplayTxt.y", getProperty("healthBar.y")-60)
	...
	setTextString('v4TimeTxt',string.upper(songName))
    addLuaText("v4TimeTxt",true)
	...
	if (songName == "D'lowing") then
	makeLuaText('creditCreator', creatorD, objWidth, offsetX - objWidth, offsetY+41)
	...
	if (songName == "Blackout") then
	makeLuaText('creditCreator', creatorB, objWidth, offsetX - objWidth, offsetY+41)
	setTextFont('creditCreator', 'arial-v4.ttf')
	setTextSize('creditCreator', 25)
	setTextBorder('creditCreator', 1, '000000')
	setTextAlignment('creditCreator', 'left')
	...
	if (songName == "Monsters") then
	makeLuaText('creditCreator', creatorM, objWidth, offsetX - objWidth, offsetY+41)
	setTextFont('creditCreator', 'arial-v4.ttf')
	setTextSize('creditCreator', 25)
	setTextBorder('creditCreator', 1, '000000')
	setTextAlignment('creditCreator', 'left')
...
function onUpdatePost(elapsed)
	if start == true and getProperty('v4TimeTxt.text') ~= "" then
		setTextString('v4TimeTxt', string.upper(getProperty('v4TimeTxt.text')))
	end
...
function onTimerCompleted(tag)
    ...
    if tag == "creditDisplay" then
        doTweenX("creditBoxTween", "creditBox", getProperty("creditBox.x") - objWidth, 0.5, "circInOut")
        doTweenX("creditTitleTween", "creditTitle", getProperty("creditTitle.x") - objWidth, 0.5, "circInOut")
        doTweenX("creditCreatorTween", "creditCreator", getProperty("creditCreator.x") - objWidth, 0.5, "circInOut")
    end
end
